...
const projectData = [
  ...
  { id: "13", title: "PROJECT 13 - CAWANG", description: "Our company has successfully completed an epoxy flooring installation in the Cawang area. The project involved applying high-quality epoxy to provide a durable, seamless surface that can withstand heavy traffic and demanding conditions. This solution not only enhances the area's functionality but also improves its aesthetic appeal with a smooth and glossy finish. The epoxy flooring ensures long-lasting performance and easy maintenance, making it an ideal choice for both commercial and industrial spaces.", images: [ecawangsatu, ecawangdua] },
