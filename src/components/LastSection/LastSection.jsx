  ...
  return (
    <section className="bg-black py-16">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <h2 className="lg:text-7xl text-5xl font-bold mb-4 text-white">
             Engage With Us in
         <span className="block lg:text-7xl text-5xl text-white">Conversation</span>
        </h2>
          <p className="text-lg text-white mb-6 pt-6">
